...
# popln <- read_csv("Data/popln/ACSDT5Y2020.B01003-Data.csv")
...
#write.csv(df_full, "df_full_hw4_4.30")
```
...
#write.csv(df_pca_rejoined, "df_hw4.csv")
# write.csv(hvi, "hvi_updated4_21.csv")
hvi
```
    ...
    leaflet() %>%
      ...
      addPolygons(data = hw4_df3, fillColor = ~pal(hw4_df3$vulnerability_score), fillOpacity = 0.7,
                  ...
                  popup = paste("Census Tract: ", hw4_df3$GEOID, "<br>",
                                "Vulnerability Score: ", hw4_df3$vulnerability_score))
  })
